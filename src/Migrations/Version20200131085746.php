 ...
 */
final class Version20200131085746 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE les ADD naam VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE training CHANGE kosten kosten VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE login_user CHANGE roles roles JSON NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE les DROP naam');
        $this->addSql('ALTER TABLE login_user CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin');
        $this->addSql('ALTER TABLE registratie CHANGE betaling betaling NUMERIC(10, 2) DEFAULT \'NULL\'');
